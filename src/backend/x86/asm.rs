...
impl Assembler {
    ...
    pub fn push(&mut self, src: impl IntoOp) {
        let src = src.into_op();
        match src {
    ...
    pub fn jg(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::G, target);
    }

    pub fn jge(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::Ge, target);
    }

    pub fn jl(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::L, target);
    }

    pub fn jle(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::Le, target);
    }

    pub fn ja(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::A, target);
    }

    pub fn jae(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::Ae, target);
    }

    pub fn jb(&mut self, target: impl IntoJmpTarget) {
        self.jcc(Cond::B, target);
    }

    pub fn jbe(&mut self, target: impl IntoJmpTarget) {
