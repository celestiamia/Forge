...
mod tests {
    ...
    fn lea_base_index_scale() -> Result<()> {
        ...
        a.lea(
            Reg::Rax,
            Mem::base_index_scale(Reg::Rbx, Reg::Rcx, Scale::Four),
        )?;
    ...
    fn jmp_forward_and_backward() -> Result<()> {
        ...
        assert_eq!(
            bytes,
            &[
                0x48, 0xC7, 0xC0, 0x00, 0x00, 0x00, 0x00, 0xE9, 0x07, 0x00, 0x00, 0x00, 0x48, 0xC7,
                0xC0, 0x01, 0x00, 0x00, 0x00, 0xE9, 0xE8, 0xFF, 0xFF, 0xFF,
            ]
        );
        Ok(())
    }
    ...
    fn je_jne_labels() -> Result<()> {
        ...
        assert_eq!(
            bytes,
            &[
                0x48, 0x39, 0xD8, 0x0F, 0x84, 0x07, 0x00, 0x00, 0x00, 0x48, 0xC7, 0xC0, 0x00, 0x00,
                0x00, 0x00, 0x0F, 0x85, 0xFA, 0xFF, 0xFF, 0xFF,
            ]
        );
        Ok(())
    }
